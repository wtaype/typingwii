import{t as e}from"./vendor-BDh6mtVu.js";import{a as t,b as n,d as r,i,v as a}from"./widev-COmfIAwj.js";import{t as o}from"./wii-k5y-1NE-.js";import{a as s,c,d as l,g as u,i as d,l as f,m as p,p as m,t as h}from"./firebase-sojJ90-r.js";import{n as g}from"./firebase-DsbKBtA3.js";var _=[],v=null,y=!1,b=null,x=null,S=`wi_mensajes_cache`,C=50,w=()=>r(`wiSmile`)||{},T=e=>{try{localStorage.setItem(S,JSON.stringify(e))}catch{}},E=()=>{try{return JSON.parse(localStorage.getItem(S)||`[]`)}catch{return[]}},D=()=>{let e=document.getElementById(`wmChat`);e&&requestAnimationFrame(()=>e.scrollTop=e.scrollHeight)},O=()=>{let e=w();if(!e.email)return location.replace(`/`),``;let n=e.nombre||e.usuario||e.email,r=e.foto||`/typingwii/v18/smile.avif`,[i]=(e.tema||`Cielo|#0EBEFF`).split(`|`);return`
      ...
      <div class="wm_header_left">
        <div class="wm_hdr_avatar_wrap">
          <img class="wm_hdr_avatar"
            src="${r}" alt="${n}"
            onerror="this.src='/typingwii/v18/smile.avif'">
