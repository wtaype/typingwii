import{t as e}from"./vendor-BykwZZMm.js";import{d as t,n,o as r,u as i}from"./widev-lipIOncV.js";import{d as a,i as o,l as s,m as c,n as l,o as u,t as d,u as f}from"./firebase-DxKr4V-p.js";import{n as p,t as m}from"./firebase-CKhCNoOL.js";var h=`wiAudios`,g=`wiImg`,_=()=>r(`wiSmile`)?.email||m.currentUser?.email||``,v=async e=>{let t=_();return t?(await o(u(f(p,e),s(`email`,`==`,t)))).docs.map(e=>({id:e.id,...e.data()})).sort((e,t)=>(t.creado?.seconds||0)-(e.creado?.seconds||0)):[]},y=async(e,t,n)=>{let r=_();return r?(await d(f(p,e),{email:r,titulo:t,src:n,creado:c(),actualizado:c()})).id:null},b=async(e,t)=>{await l(a(p,e,t))},x=()=>v(h),S=()=>v(g),C=(e,n)=>`
