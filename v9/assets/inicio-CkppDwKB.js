...
<div class="ini_wrap">
  ...
  <section class="ini_cta_sec">
    <div class="ini_cta_wrap">
      ...
      <p class="ini_cta_autor">Hecho con ❤️ por <a href="${a}" target="_blank" rel="noopener">${o}</a> © ${r()}</p>
    </div>
  </section>

</div>`,y=null,b=()=>{let t=0,r=e(`.ini_role`);y=setInterval(()=>{r.removeClass(`active`),r.eq(t=(t+1)%r.length).addClass(`active`)},2800),n(`#in_stats`,()=>{e(`.ini_stat_n`).each(function(){let t=e(this),n=+t.data(`target`),r=t.data(`sufijo`)||``,i=0,a=setInterval(()=>{i+=n/50,i>=n?(t.text(n+r),clearInterval(a)):t.text(Math.floor(i))},28)})}),n(`.ini_cat_card`,null,{anim:`wi_fadeUp`,stagger:80}),n(`.ini_about_card`,null,{anim:`wi_fadeUp`,stagger:140}),n(`.ini_cta_wrap`,null,{anim:`wi_fadeUp`}),n(`.ini_sec_head`,null,{anim:`wi_fadeUp`}),n(`.ini_eco_card`,null,{anim:`wi_fadeUp`,stagger:100}),console.log(`🚀 ${s} v9 · Inicio OK`)},x=()=>{clearInterval(y),e(document).off(`.inicio`)};export{x as cleanup,b as init,v as render};