import{t as e}from"./vendor-BykwZZMm.js";import{d as t,o as n,p as r,s as i,t as a}from"./widev-lipIOncV.js";import{t as o}from"./ruta-h1e9AYQT.js";import{c as s,d as c}from"./firebase-DxKr4V-p.js";import{n as l}from"./firebase-CKhCNoOL.js";var u=()=>n(`wiSmile`)||{},d=()=>{let e=u();if(!e.email)return location.replace(`/`),``;let n=e.nombre||``,r=e.apellidos||``,i=e.usuario||``,a=e.email||``,o=e.rol||`smile`,s=e.uid||``,c=e.imagen||`./smile.avif`;return((n[0]||``)+(r[0]||``)).toUpperCase(),`
  <div class="prf_wrap">
