import{t as e}from"./vendor-BykwZZMm.js";import{a as t,i as n,n as r,t as i}from"./wii-BjvkTm-Q.js";function a(){let e=new Date;return`
  <footer class="foo wb txc psa">
    <span>Creado con <i class="fas fa-heart"></i> by <a class="ftx lkme" href="${t}" target="_blank">${r}</a></span>
    <span>${n} - <span class="wty">${e.getFullYear()}</span></span>
    <span class="abw"> | ${i} v9 | actualizado:
    <span class="wtu">${e.toLocaleString()}</span></span>
  </footer>
  `}e(`body`).append(a()),e(`head`).append(`<style>:root{--bgim:url("/typingwii/v9/wpuntos.svg")}body{background: var(--bgim), var(--bg)}</style>`);var o=()=>`<div class="movil_divider"></div>${e(`.nv_right`).html()}`;e(`body`).append(`<div class="movil_overlay"></div>
