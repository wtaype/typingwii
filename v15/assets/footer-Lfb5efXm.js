import{t as e}from"./vendor-BDh6mtVu.js";import{a as t,n,o as r,t as i}from"./wii-CH56_JtA.js";function a(){let e=new Date;return`
  <footer class="foo wb txc psa">
    ...
    <span class="abw"> | ${i} v15 | actualizado:
    <span class="wtu">${e.toLocaleString()}</span></span>
  </footer>
  `}e(`body`).append(a()),e(`head`).append(`<style>:root{--bgim:url("/typingwii/v15/wpuntos.svg")}body{background: var(--bgim), var(--bg)}</style>`);var o=()=>`<div class="movil_divider"></div>${e(`.nv_right`).html()}`;e(`body`).append(`<div class="movil_overlay"></div>
