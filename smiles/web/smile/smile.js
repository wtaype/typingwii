  ...
  <div class="sm_bv_wrap">
    ...
    <div class="sm_mot_card" id="sm_motivacion">
      ...
      <div class="sm_mot_body">
        ...
        <div class="sm_mot_txt" id="sm_frase_txt">${frase.txt}</div>
      </div>
      ...
      ${ACCESOS.map(a => `
        <a href="${a.href}" class="sm_acceso_card nv_item" data-page="${a.page}">
          ...
          <div class="sm_acceso_info">
            <div class="sm_acceso_title">${a.title}</div>
            <div class="sm_acceso_sub">${a.sub}</div>
          </div>
...
export const init = () => {
  ...
  $(document).on('click.sm_dash', '#sm_btn_frase', function () {
    ...
    setTimeout(() => {
      ...
      $card.find('.sm_mot_ico i').attr('class', `fas ${nueva.ico}`);
      $card.removeClass('sm_mot_out').addClass('sm_mot_in');
      setTimeout(() => $card.removeClass('sm_mot_in'), 350);
    }, 240);
  });
