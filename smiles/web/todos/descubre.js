...
// ── DATA ──────────────────────────────────────────────────────────
const TEMAS = [
  { n: 'Cielo', c: '#0EBEFF', d: 'Inspirado en la calma del horizonte digital.' },
  { n: 'Bosque', c: '#28a745', d: 'Tonos naturales para una concentración total.' },
  { n: 'Fuego', c: '#FF5C69', d: 'Energía pura para los que buscan velocidad récord.' },
  { n: 'Mora', c: '#7000FF', d: 'Sofisticación y elegancia en cada pulsación.' },
  { n: 'Ocaso', c: '#fd7e14', d: 'Calidez para sesiones de práctica nocturnas.' },
  { n: 'Noche', c: '#24292e', d: 'Contraste perfecto para el modo oscuro real.' },
];

const FEATURES = [
  { ico: 'fa-gauge-high', t: 'Velocidad Real', d: 'Calculamos tus WPM (Palabras por minuto) de forma bruta y neta con precisión milimétrica.' },
  { ico: 'fa-bullseye', t: 'Precisión Inteligente', d: 'No solo contamos errores, analizamos qué letras te cuestan más para sugerirte prácticas.' },
  { ico: 'fa-keyboard', t: 'Visual Typing', d: 'Teclado virtual dinámico que te guía sobre qué dedo usar en cada momento.' },
  { ico: 'fa-chart-line', t: 'Gráficas de Progreso', d: 'Visualiza tu evolución a lo largo de los días con reportes automáticos.' },
  { ico: 'fa-shield-halved', t: 'Sin Distracciones', d: 'Interfaz minimalista diseñada para que solo existas tú y el texto frente a ti.' },
  { ico: 'fa-cloud-arrow-up', t: 'Sincronización Pro', d: 'Tus récords se guardan en la nube para que compitas contigo mismo donde sea.' },
];
...
<div class="des_page">
  ...
  <section class="des_sec des_sec_alt">
    ...
    <div class="des_grid_3">
      ${FEATURES.map((f, i) => `
        <div class="des_feat_card wi_fadeUp" style="--d:${i * .08}s">
          <div class="des_feat_ico"><i class="fas ${f.ico}"></i></div>
          <h3>${f.t}</h3>
          <p>${f.d}</p>
        </div>`).join('')}
    </div>
  ...
  <section class="des_sec">
    ...
    <div class="des_temas_grid">
      ${TEMAS.map((t, i) => `
        <div class="des_tema_card wi_fadeUp" style="--tc:${t.c};--d:${i * .1}s">
    ...
    <div class="des_cta_card">
      ...
      <div class="des_cta_inner">
        ...
        <div class="des_cta_txt">
          ...
          <p>La mejor forma de descubrir ${app} es sentándote frente al teclado.</p>
        </div>
...
export const init = () => {
  _obs = [
    ...
    wiVista('.des_feat_card', null, { anim: 'wi_fadeUp', stagger: 80 }),
    wiVista('.des_tema_card', null, { anim: 'wi_fadeUp', stagger: 100 }),
  ];
  console.log(`✨ ${app} — Descubre listo`);
};
