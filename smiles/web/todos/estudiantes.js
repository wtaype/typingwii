...
// ── DATOS ──────────────────────────────────────────────────────────
const BENEFICIOS = [
  { ico: 'fa-bolt',          c: '#0EBEFF', t: 'Aprende más rápido',     d: 'Con nuestro método progresivo pasarás de 0 a 60 WPM en semanas. Cada lección construye sobre la anterior.' },
  { ico: 'fa-certificate',   c: '#fd7e14', t: 'Certificado digital',    d: 'Al completar cada nivel obtienes un certificado oficial con tu nombre, WPM y fecha. Perfecto para tu portafolio.' },
  { ico: 'fa-chart-line',    c: '#28a745', t: 'Ve tu progreso real',    d: 'Historial completo de tus resultados. Gráficas de WPM y precisión lección a lección para que veas tu evolución.' },
  { ico: 'fa-mobile-screen', c: '#7000FF', t: 'En cualquier dispositivo',d: 'Laptop, tablet o celular. Tu progreso se sincroniza automáticamente. Practica donde y cuando quieras.' },
  { ico: 'fa-gift',          c: '#FF5C69', t: '100% gratuito',          d: 'Sin costos ocultos, sin suscripciones. Accede a todas las lecciones y herramientas completamente gratis.' },
  { ico: 'fa-envelope',      c: '#FFD101', t: 'Apoyo del instructor',   d: 'Comunícate directamente con tu profesor desde la plataforma. Recibe feedback personalizado en tiempo real.' },
];

const PASOS = [
  { n: '01', ico: 'fa-user-plus', t: 'Regístrate gratis',     d: 'Crea tu cuenta en menos de 1 minuto. Solo necesitas tu correo y elegir un nombre de usuario.' },
  { n: '02', ico: 'fa-keyboard',  t: 'Elige tu lección',      d: 'Empieza desde la lección 1 o desde donde te sientas cómodo. El sistema te guía paso a paso.' },
  { n: '03', ico: 'fa-fire',      t: 'Practica cada día',     d: '15 minutos al día es suficiente. La constancia supera a la intensidad en la mecanografía.' },
  { n: '04', ico: 'fa-trophy',    t: 'Obtén tu certificado',  d: 'Al superar la meta de cada nivel, descarga tu certificado digital personalizado.' },
];

const STATS = [
  { n: '12',   l: 'Lecciones',         ico: 'fa-book-open'    },
  { n: '5',    l: 'Niveles',           ico: 'fa-layer-group'  },
  { n: '70',   l: 'WPM posible',       ico: 'fa-bolt'         },
  { n: '100%', l: 'Gratis',            ico: 'fa-gift'         },
];
...
<div class="pu_page est_page">
  ...
  <section class="pu_hero est_hero">
    ...
    <div class="pu_hero_inner">
      <div class="pu_hero_left">
        <div class="pu_badge"><i class="fas fa-graduation-cap"></i> Para estudiantes · ${app}</div>
        <h1 class="pu_h1">
        ...
        <div class="pu_quick_stats">
          ${STATS.map(s => `
            <div class="pu_qs">
              <span class="pu_qs_n">${s.n}</span>
              <span class="pu_qs_l"><i class="fas ${s.ico}"></i> ${s.l}</span>
      ...
      <div class="pu_hero_right">
        <div class="est_preview_card">
          <div class="est_pc_header">
            ...
            <span class="est_pc_title"><i class="fas fa-keyboard"></i> ${app} · Dashboard</span>
          </div>
  ...
  <section class="pu_sec">
    <div class="pu_sec_head wi_fadeUp">
      <div class="pu_sec_badge"><i class="fas fa-star"></i> ¿Por qué elegir ${app}?</div>
    ...
    <div class="pu_grid_3">
      ${BENEFICIOS.map((b, i) => `
        <div class="pu_bene_card wi_fadeUp" style="--bc:${b.c};--d:${i * .08}s">
          <div class="pu_bene_ico"><i class="fas ${b.ico}"></i></div>
          <h3 class="pu_bene_t">${b.t}</h3>
          <p class="pu_bene_d">${b.d}</p>
        </div>`).join('')}
    </div>
  </section>
  ...
  <section class="pu_sec pu_sec_alt">
    ...
    <div class="pu_pasos_grid">
      ${PASOS.map((p, i) => `
        <div class="pu_paso wi_fadeUp" style="--d:${i * .1}s">
          <div class="pu_paso_num">${p.n}</div>
          <div class="pu_paso_ico"><i class="fas ${p.ico}"></i></div>
          <h3 class="pu_paso_t">${p.t}</h3>
          <p class="pu_paso_d">${p.d}</p>
          ${i < PASOS.length - 1 ? '<div class="pu_paso_arrow"><i class="fas fa-arrow-right"></i></div>' : ''}
        </div>`).join('')}
    </div>
  </section>
    ...
    <div class="pu_cta_card" style="--cta_c:#0EBEFF">
      ...
      <div class="pu_cta_inner">
        <div class="pu_cta_txt">
          ...
          <p>Únete a ${app} gratis y transforma tu forma de escribir. Tu primer certificado te espera. 🏆</p>
        </div>
...
export const init = () => {
  ...
  console.log(`🎓 ${app} — Estudiantes listo`);
};
