...
const WK_ROWS = [
  [
    ['Escape','Esc','lp',1],['F1','F1','lp',1],['F2','F2','lr',1],['F3','F3','lm',1],
    ['F4','F4','li',1],['F5','F5','li',1],['F6','F6','ri',1],['F7','F7','ri',1],
    ['F8','F8','rm',1],['F9','F9','rr',1],['F10','F10','rp',1],['F11','F11','rp',1],['F12','F12','rp',1],['F13','F13','rp',1],['F14','F14','rp',1]
  ],
  [
  ...
  [
    ['Control','Ctrl','lp',1.5],['Meta','Win','lp',1.2],['Alt','Alt','th',1.3],
    [' ','SPACE','th',6],
    ['AltR','Alt Gr','th',1.3],['MetaR','Win','rp',1.2],['ContextMenu','Menu','rp',1.2],['ControlR','Ctrl','rp','flex'],
  ],
];
