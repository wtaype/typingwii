import{t as e}from"./wii-CZYUy4T7.js";import{t}from"./vendor-BDh6mtVu.js";import{g as n,i as r,y as i}from"./widev-CFII55yl.js";var a=()=>`
<div class="con_page">
...
`,o=[],s=()=>{o=[i(`.wi_fadeUp`,null,{anim:`wi_fadeUp`})],t(document).off(`.con`),t(document).on(`submit.con`,`#con_form`,function(e){e.preventDefault();let i=t(`#con_btn_enviar`);n(i,!0,`Enviando...`),setTimeout(()=>{n(i,!1,`Guardado`),r(`¡Mensaje enviado correctamente! Te responderemos pronto.`,`success`),this.reset(),setTimeout(()=>{i.html(`<i class="fas fa-paper-plane"></i> Enviar mensaje`)},2e3)},1500)}),console.log(`✉️ ${e} — Página de contacto lista`)},c=()=>{o.forEach(e=>e?.disconnect?.()),o=[],t(document).off(`.con`)};export{c as cleanup,s as init,a as render};