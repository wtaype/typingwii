    ...
    <div class="pu_hero_inner">
      <div class="pu_hero_left">
        ...
        <p class="pu_sub">
          ...
          Con ${n} capacitas a todo tu equipo en mecanografía de forma
      ...
      <div class="pu_hero_right">
        ...
        <div class="emp_sectores_wrap">
          ...
          <div class="emp_sec_grid">
            ${a.map(t=>`
              <div class="emp_sector_item" ${e(t.lbl)}>
                <i class="fas ${t.ico}"></i>
                <span>${t.lbl}</span>
              </div>`).join(``)}
          </div>
...
</div>`,c=[],l=()=>{c=[t(`.pu_bene_card`,null,{anim:`wi_fadeUp`,stagger:80}),t(`.emp_plan_card`,null,{anim:`wi_fadeUp`,stagger:120}),t(`.wi_fadeUp`,null,{anim:`wi_fadeUp`})],console.log(`🏢 ${n} — Empresas listo`)},u=()=>{c.forEach(e=>e?.disconnect?.()),c=[]};export{u as cleanup,l as init,s as render};