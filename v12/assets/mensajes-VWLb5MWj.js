import{t as e}from"./vendor-BDh6mtVu.js";import{a as t,b as n,d as r,i,v as a}from"./widev-C3WiqJry.js";import{t as o}from"./wii-Cxd7Wgv5.js";import{a as s,c,d as l,f as u,h as d,i as f,l as p,p as m,t as h}from"./firebase-CcmtvWrk.js";import{db as g}from"./firebase-dKwBjBLJ.js";var _=[],v=null,y=!1,b=null,x=null,S=`wi_mensajes_cache`,C=50,w=()=>r(`wiSmile`)||{},T=e=>{try{localStorage.setItem(S,JSON.stringify(e))}catch{}},E=()=>{try{return JSON.parse(localStorage.getItem(S)||`[]`)}catch{return[]}},D=()=>{let e=document.getElementById(`wmChat`);e&&requestAnimationFrame(()=>e.scrollTop=e.scrollHeight)},O=()=>{let e=w();if(!e.email)return location.replace(`/`),``;let n=e.nombre||e.usuario||e.email,r=e.foto||`/typingwii/v12/smile.avif`,[i]=(e.tema||`Cielo|#0EBEFF`).split(`|`);return`
