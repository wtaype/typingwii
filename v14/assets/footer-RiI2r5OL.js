import{t as e}from"./vendor-BDh6mtVu.js";import{a as t,n,o as r,t as i}from"./wii-CchEM3S9.js";function a(){let e=new Date;return`
  ...
  `}e(`body`).append(a()),e(`head`).append(`<style>:root{--bgim:url("/typingwii/v14/wpuntos.svg")}body{background: var(--bgim), var(--bg)}</style>`);var o=()=>`<div class="movil_divider"></div>${e(`.nv_right`).html()}`;e(`body`).append(`<div class="movil_overlay"></div>
