    ...
    <div class="des_cta_card">
      ...
      <div class="des_cta_inner">
        ...
        <div class="des_cta_txt">
          ...
          <p>La mejor forma de descubrir ${e} es sentándote frente al teclado.</p>
        </div>
...
</div>`,a=[],o=()=>{a=[t(`.wi_fadeUp`,null,{anim:`wi_fadeUp`}),t(`.des_feat_card`,null,{anim:`wi_fadeUp`,stagger:80}),t(`.des_tema_card`,null,{anim:`wi_fadeUp`,stagger:100})],console.log(`✨ ${e} — Descubre listo`)},s=()=>{a.forEach(e=>e?.disconnect?.()),a=[]};export{s as cleanup,o as init,i as render};