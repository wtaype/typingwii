import{t as e}from"./vendor-BDh6mtVu.js";import{C as t,a as n,d as r,f as i,l as a,r as o,s,t as c,u as l}from"./widev-BVXcYvSP.js";import"./wii-9R-ZUv6c.js";import{a as u,c as d,d as f,i as p,p as m,s as h}from"./firebase-sojJ90-r.js";import{n as g}from"./firebase-IxF1L4zF.js";var _=()=>r(`wiSmile`),v=`epTotalEmpleados`,y=`epTotalEquipos`,b=`epMetricas`,x=`epFeed`,S=async()=>{let e=_();if(!e)return`<div class="epd_page"><div class="epd_empty"><i class="fas fa-lock"></i><p>Sin sesión activa.</p></div></div>`;let t=o(e.nombres||e.nombre||`Administrador`),i=s(e.nombres||e.nombre||``),l=e.foto||null,u=c(e.empresa||`TypingWii`),d=r(v)??`—`,f=r(y)??`—`,p=r(b)||{wpm:`—`,cert:`—`};return`
  <div class="epd_page">
