...
<div class="pu_page est_page">
  ...
  <section class="pu_hero est_hero">
    ...
    <div class="pu_hero_inner">
      <div class="pu_hero_left">
        <div class="pu_badge"><i class="fas fa-graduation-cap"></i> Para estudiantes · ${e}</div>
        <h1 class="pu_h1">
      ...
      <div class="pu_hero_right">
        <div class="est_preview_card">
          <div class="est_pc_header">
            ...
            <span class="est_pc_title"><i class="fas fa-keyboard"></i> ${e} · Dashboard</span>
          </div>
  ...
  <section class="pu_sec">
    <div class="pu_sec_head wi_fadeUp">
      <div class="pu_sec_badge"><i class="fas fa-star"></i> ¿Por qué elegir ${e}?</div>
    ...
    <div class="pu_cta_card" style="--cta_c:#0EBEFF">
      ...
      <div class="pu_cta_inner">
        <div class="pu_cta_txt">
          ...
          <p>Únete a ${e} gratis y transforma tu forma de escribir. Tu primer certificado te espera. 🏆</p>
        </div>
...
</div>`,o=[],s=()=>{o=[t(`.pu_bene_card`,null,{anim:`wi_fadeUp`,stagger:80}),t(`.pu_paso`,null,{anim:`wi_fadeUp`,stagger:100}),t(`.wi_fadeUp`,null,{anim:`wi_fadeUp`})],console.log(`🎓 ${e} — Estudiantes listo`)},c=()=>{o.forEach(e=>e?.disconnect?.()),o=[]};export{c as cleanup,s as init,a as render};