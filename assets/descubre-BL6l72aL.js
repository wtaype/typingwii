import{t as e}from"./vendor-BykwZZMm.js";import{t}from"./wii-BjvkTm-Q.js";var n=()=>`
    ...
    <section class="desc_testimonios">
      <div class="testimonios_wrapper">
        <div class="section_header">
          ...
          <p>Miles de personas ya confían en ${t}</p>
        </div>
    ...
    <section class="desc_cta">
      <div class="cta_wrapper">
        <div class="cta_content">
          ...
          <p>Únete a miles de personas que ya usan ${t} para compartir amor y emociones</p>
...
`,r=()=>{console.log(`✅ Descubre de ${t} cargado`),i()};function i(){let t=new IntersectionObserver(e=>{e.forEach(e=>{e.isIntersecting&&e.target.classList.add(`visible`)})},{threshold:.1});e(`.feature_item, .paso_card, .testimonio_card, .stat_box, .visual_card`).each(function(){t.observe(this)})}var a=()=>{console.log(`🧹 Descubre limpiado`)};export{a as cleanup,r as init,n as render};