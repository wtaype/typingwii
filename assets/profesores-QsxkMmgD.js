  ...
  <section class="pu_hero pro_hero">
    ...
    <div class="pu_hero_inner">
      <div class="pu_hero_left">
        ...
        <p class="pu_sub">
          ${t} te da las herramientas para que tus alumnos aprendan mecanografía
    ...
    <div class="pu_cta_card" style="--cta_c:#28a745;background:linear-gradient(135deg,#28a745,#1a7a32)">
      ...
      <div class="pu_cta_inner">
        <div class="pu_cta_txt">
          ...
          <h2>¿Quieres gestionar tu aula con ${t}?</h2>
...
</div>`,o=[],s=()=>{o=[e(`.pu_bene_card`,null,{anim:`wi_fadeUp`,stagger:80}),e(`.pu_paso`,null,{anim:`wi_fadeUp`,stagger:100}),e(`.wi_fadeUp`,null,{anim:`wi_fadeUp`})],console.log(`🏫 ${t} — Profesores listo`)},c=()=>{o.forEach(e=>e?.disconnect?.()),o=[]};export{c as cleanup,s as init,a as render};