import{t as e}from"./ruta-CdwgGk9K.js";import{t}from"./vendor-BDh6mtVu.js";import{_ as n,c as r,o as i,t as a,y as o}from"./widev-vIOvrNXT.js";import{s,u as c}from"./firebase-D6Mg1KLq.js";import{db as l}from"./firebase-C6ZXw370.js";var u=()=>i(`wiSmile`)||{},d=()=>{let e=u();if(!e.email)return location.replace(`/`),``;let t=e.nombre||``,r=e.apellidos||``,i=e.usuario||``,a=e.email||``,o=e.rol||`smile`,s=e.uid||``,c=e.imagen||`./smile.avif`;return((t[0]||``)+(r[0]||``)).toUpperCase(),`
  <div class="prf_wrap">
