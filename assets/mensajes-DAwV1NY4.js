import{t as e}from"./vendor-BDh6mtVu.js";import{a as t,b as n,d as r,i,v as a}from"./widev-CCD3iiJo.js";import{t as o}from"./wii-C22GvKhM.js";import{a as s,c,d as l,g as u,i as d,l as f,m as p,p as m,t as h}from"./firebase-sojJ90-r.js";import{n as g}from"./firebase-C4aBgM1z.js";var _=[],v=null,y=!1,b=null,x=null,S=`wi_mensajes_cache`,C=50,w=()=>r(`wiSmile`)||{},T=e=>{try{localStorage.setItem(S,JSON.stringify(e))}catch{}},E=()=>{try{return JSON.parse(localStorage.getItem(S)||`[]`)}catch{return[]}},D=()=>{let e=document.getElementById(`wmChat`);e&&requestAnimationFrame(()=>e.scrollTop=e.scrollHeight)},O=()=>{let e=w();if(!e.email)return location.replace(`/`),``;let n=e.nombre||e.usuario||e.email,r=e.foto||`/typingwii/smile.avif`,[i]=(e.tema||`Cielo|#0EBEFF`).split(`|`);return`
