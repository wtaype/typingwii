import{t as e}from"./vendor-BDh6mtVu.js";import{d as t,f as n,i as r}from"./widev-CCD3iiJo.js";import{t as i}from"./wii-C22GvKhM.js";import{c as a,d as o,n as s,p as c}from"./firebase-sojJ90-r.js";import{n as l}from"./firebase-C4aBgM1z.js";var u=()=>t(`wiSmile`),d=`amUsersTotal`,f=`amUsersPro`,p=`amOrgsTotal`,m=`amLessonsTotal`,h=()=>{let e=u();return!e||e.rol!==`admin`?`<div class="am_page"><div class="am_empty"><i class="fas fa-ban"></i> Acceso denegado.</div></div>`:`
  <div class="am_page">
