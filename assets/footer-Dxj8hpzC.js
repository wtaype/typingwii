import{a as e,n as t,o as n,t as r}from"./wii-B0uic5Eu.js";import{t as i}from"./vendor-BDh6mtVu.js";function a(){let i=new Date;return`
  ...
  `}i(`body`).append(a()),i(`head`).append(`<style>:root{--bgim:url("/typingwii/wpuntos.svg")}body{background: var(--bgim), var(--bg)}</style>`);var o=()=>`<div class="movil_divider"></div>${i(`.nv_right`).html()}`;i(`body`).append(`<div class="movil_overlay"></div>
