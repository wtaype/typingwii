...
</div>`,o=[],s=!1,c=()=>{o=[n(`.prc_plan`,null,{anim:`wi_fadeUp`,stagger:130}),n(`.prc_faq_item`,null,{anim:`wi_fadeUp`,stagger:70}),n(`.wi_fadeUp`,null,{anim:`wi_fadeUp`})],t(document).off(`.prc`),t(document).on(`click.prc`,`#prc_toggle, .prc_tog_lbl`,()=>{s=!s,t(`#prc_tog_ball`).toggleClass(`prc_tog_on`,s),t(`#prc_tog_anual`).toggleClass(`prc_tog_act`,s),t(`.prc_tog_lbl`).first().toggleClass(`prc_tog_act`,!s);let e=t(`#prc_precio_pro`);e.addClass(`prc_precio_flip`).text(s?`$7.20`:`$9`).one(`animationend`,()=>e.removeClass(`prc_precio_flip`))}),t(document).on(`click.prc`,`.prc_faq_item`,function(){let e=t(this),n=e.hasClass(`prc_faq_open`);t(`.prc_faq_item`).removeClass(`prc_faq_open`),n||e.addClass(`prc_faq_open`)}),console.log(`💳 ${e} — Precios listo`)},l=()=>{o.forEach(e=>e?.disconnect?.()),o=[],t(document).off(`.prc`)};export{l as cleanup,c as init,a as render};