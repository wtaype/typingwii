...
<div class="ac_page">
  ...
  <section class="ac_hero">
    ...
    <div class="ac_hero_inner">
      ...
      <p class="ac_sub">En ${e}, nuestra misión es empoderar a estudiantes y profesionales con la habilidad digital más fundamental: la mecanografía rápida y precisa.</p>
    </div>
  </section>
  ...
  <section class="ac_sec">
    <div class="ac_mision_grid">
      ...
      <div class="ac_mision_txt wi_fadeUp" style="--d:.15s">
        ...
        <h2 class="ac_sec_h2">¿Qué es <span class="ac_grad">${e}</span>?</h2>
        <p class="ac_sec_p">
          ${e} nació como un proyecto personal para resolver una necesidad común: la falta de plataformas profesionales, gratuitas y divertidas para aprender mecanografía en español. 
          <br><br>
    ...
    <div class="ac_cta_card">
      ...
      <div class="ac_cta_inner">
        ...
        <div class="ac_cta_txt">
          ...
          <p>Únete a miles de personas que ya están escribiendo como expertos en ${e}.</p>
        </div>
...
</div>`,a=[],o=()=>{a=[t(`.wi_fadeUp`,null,{anim:`wi_fadeUp`}),t(`.ac_valor_card`,null,{anim:`wi_fadeUp`,stagger:100})],console.log(`ℹ️ ${e} — Acerca de listo`)},s=()=>{a.forEach(e=>e?.disconnect?.()),a=[]};export{s as cleanup,o as init,i as render};